...
// Default color scheme - Grey & Navy (Dark) / Steel Blue & Grey-White (Light)
const defaultColorScheme: ColorScheme = {
  name: 'Professional',
  // Primary: Steel Blue (light) / Navy (dark)
  primary: {
    50: '#e8f0f7',   // Very light steel blue
    100: '#d1e1ef',  // Light steel blue
    200: '#a3c3df',  // Lighter steel blue
    300: '#75a5cf',  // Light-medium steel blue
    400: '#5a8fc7',  // Medium steel blue
    500: '#4682b4',  // Steel blue (main)
    600: '#3a6b96',  // Medium-dark steel blue
    700: '#2e5478',  // Dark steel blue
    800: '#1e3a5f',  // Navy (dark mode primary)
    900: '#0f1d2f',  // Deep navy
  },
  // Secondary: Soft Grey/White (light) / Grey (dark)
  secondary: {
    50: '#f5f5f5',   // Soft off-white (no harsh white)
    100: '#e8e8e8',  // Very light grey
    200: '#d1d1d1',  // Light grey
    300: '#b8b8b8',  // Medium-light grey
    400: '#9a9a9a',  // Medium grey
    500: '#7a7a7a',  // Medium-dark grey
    600: '#5a5a5a',  // Dark grey
    700: '#4a5568',  // Darker grey (dark mode secondary)
    800: '#2d3748',  // Very dark grey
    900: '#1a202c',  // Almost black grey
  },
  // Neutral: Soft greys for light mode, darker greys for dark mode
  neutral: {
    50: '#f5f5f5',   // Soft off-white (replaces harsh white)
    100: '#e8e8e8',  // Very light grey
    200: '#d1d1d1',  // Light grey
    300: '#b8b8b8',  // Medium-light grey
    400: '#9a9a9a',  // Medium grey
    500: '#7a7a7a',  // Medium-dark grey
    600: '#5a5a5a',  // Dark grey
    700: '#4a5563',  // Darker grey
    800: '#2d3748',  // Very dark grey (dark mode neutral)
    900: '#1a202c',  // Almost black grey
  },
  semantic: {
    success: {
