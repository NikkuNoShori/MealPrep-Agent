  ...
  return (
    <div ref={ref} className="relative inline-block">
      <button
        ...
        className={`inline-flex items-center gap-1.5 rounded-lg border border-border/60 bg-background/80 backdrop-blur-sm shadow-sm transition-all duration-200 hover:border-primary/40 hover:shadow-md hover:bg-accent/50 active:scale-[0.97] ${
      ...
      {isOpen && (
        <div
          className="absolute right-0 z-50 mt-1.5 w-52 rounded-xl border border-border/60 bg-popover/95 backdrop-blur-md shadow-lg shadow-black/10 animate-in fade-in-0 zoom-in-95 slide-in-from-top-2 duration-150"
              ...
              collections.map((collection: any) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-2.5 rounded-lg px-2.5 py-2 text-sm transition-all duration-150 ${
                      isIn
